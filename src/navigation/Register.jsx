      ...
      if (error.response !== undefined){
        if (error.response.status === 400) {
          ...
          if(error.response.data.email)
            setEmailError(JSON.stringify(error.response.data.email).slice(2,-2));
          if(error.response.data.first_name)
            setFirstnameError(JSON.stringify(error.response.data.first_name).slice(2,-2));
          if(error.response.data.middle_name)
            setMiddlenameError(JSON.stringify(error.response.data.middle_name).slice(2,-2));
          if(error.response.data.last_name)
            setLastnameError(JSON.stringify(error.response.data.last_name).slice(2,-2));
          if(error.response.data.password)
            setPasswordError(JSON.stringify(error.response.data.password).slice(2,-2));
          if(error.response.data.address)
            setAddressError(JSON.stringify(error.response.data.address).slice(2,-2));
          if(error.response.data.mobile_number)
            setContactnumberError(JSON.stringify(error.response.data.mobile_number).slice(2,-2));
          if(error.response.data.resident_number)
            setResidentNumberError(JSON.stringify(error.response.data.resident_number).slice(2,-2));
          if(error.response.data.date_of_birth)
            setBirthdayError(JSON.stringify(error.response.data.date_of_birth).slice(2,-2));
          if(error.response.data.age)
            setAgeError(JSON.stringify(error.response.data.age).slice(2,-2));
          if(error.response.data.gender)
            setGenderError(JSON.stringify(error.response.data.gender).slice(2,-2));
          if(error.response.data.province)
            setBirthplaceError(JSON.stringify(error.response.data.province).slice(2,-2));
          if(error.response.data.civil_status)
            setCivilstatusError(JSON.stringify(error.response.data.civil_status).slice(2,-2));
        }
            ...
            <Grid container spacing={2}>
                ...
                <MuiPickersUtilsProvider utils={DateFnsUtils}>
                  <Grid>
                    <KeyboardDatePicker
                      ...
                      error={birthdayError}
                    />
                    <Typography variant="body2"  align="left" color="secondary" name="birthdayError">
                      {birthdayError}
                    </Typography>
                  </Grid>
                </MuiPickersUtilsProvider>
              ...
              <Grid item xs={12} sm={4}>
                <TextField
                  ...
                  error={ageError}
                />
                <Typography variant="body2"  align="left" color="secondary" name="ageError">
                  {ageError}
                </Typography>
              </Grid>
              {/* Gender */}
              <Grid item xs={12} sm={4}>
                ...
                <Typography variant="body2"  align="left" color="secondary" name="genderError">
                  {genderError}
                </Typography>
              </Grid>
            </Grid>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={4}>
                <TextField
                  ...
                  error={addressError}
                />
                <Typography variant="body2"  align="left" color="secondary" name="addressError">
                  {addressError}
                </Typography>
              </Grid>
              {/* Resident Number */}
              <Grid item xs={12} sm={4}>
                ...
                />
                <Typography variant="body2"  align="left" color="secondary" name="residentNumberError">
                  {residentNumberError}
                </Typography>
              </Grid>
              {/* Birth Place */}
              <Grid item xs={12} sm={4}>
                ...
                />
                <Typography variant="body2"  align="left" color="secondary" name="birthplaceError">
                  {birthplaceError}
                </Typography>
              </Grid>
              {/* Barangay */}
              <Grid item xs={12} sm={4}>
                <TextField
                  ...
                  error={barangayError}
                />
                <Typography variant="body2"  align="left" color="secondary" name="barangayError">
                  {barangayError}
                </Typography>
              </Grid>
              {/* Contact Number */}
              ...
              <Grid item xs={12} sm={3}>
                ...
                <Typography variant="body2"  align="left" color="secondary" name="civilstatusError">
                  {civilstatusError}
                </Typography>
              </Grid>
              {/* E-mail */}
            ...
            <div className={classes.divtest}>			    
              ...
              >
                ...
                <DialogActions>
                  ...
                  <Button onClick={handleSubmitRegistration} color="primary" autoFocus>
                    Agree
                    <Dialog
                      open={openNotice}
                    ...
                    >
                      ...
                      <DialogActions>
                        <Button onClick={handleReturnHome} color="primary" autoFocus href="login">
                          OK
                        </Button>
                      </DialogActions>
                    </Dialog>
